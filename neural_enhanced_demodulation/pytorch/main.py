...
if __name__ == "__main__":
    ...
    opts.sample_dir = os.path.join(
        opts.evaluations_path, opts.dir_comment + "_" + opts.sample_dir)

    opts.checkpoint_dir = os.path.join(
        opts.evaluations_path, opts.dir_comment + "_" + opts.checkpoint_dir)

    opts.testing_dir = os.path.join(
        opts.evaluations_path, opts.dir_comment + "_" + opts.testing_dir)
